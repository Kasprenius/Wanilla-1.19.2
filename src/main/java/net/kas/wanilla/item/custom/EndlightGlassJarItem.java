...
public class EndlightGlassJarItem extends BlockItem {
    private final SoundEvent placeSound = SoundEvents.BLOCK_BEACON_POWER_SELECT;

    public EndlightGlassJarItem(Block block, Item.Settings settings) {
    ...
    public ItemStack getRecipeRemainder(ItemStack itemstack) {
        return new ItemStack(ModItems.VOIDLIGHT_GLASS_JAR);
    }
