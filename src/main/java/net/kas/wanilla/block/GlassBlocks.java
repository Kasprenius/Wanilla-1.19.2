...
import net.kas.wanilla.block.templates.GlassSlabBlock;
import net.kas.wanilla.block.templates.GlassStairsBlock;
...
public class GlassBlocks {
    ...
    public static final String[] colorNames = new String[]{"black", "blue", "brown", "cyan", "gray", "green", "light_blue", "light_gray", "lime", "magenta", "orange", "pink", "purple", "red", "yellow", "white"};
    public static final Block GLASS_SLAB = registerBlock("glass_slab",
            new GlassSlabBlock(FabricBlockSettings.of(Material.GLASS)
                    .strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque()
                    .allowsSpawning(GlassBlocks::never)
                    .solidBlock(GlassBlocks::never).
                    suffocates(GlassBlocks::never)
                    .blockVision(GlassBlocks::never)),
