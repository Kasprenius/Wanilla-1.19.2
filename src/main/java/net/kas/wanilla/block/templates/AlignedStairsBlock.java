...
public class AlignedStairsBlock extends Block implements Waterloggable {
    ...
    public AlignedStairsBlock(BlockState baseBlockState, AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)((BlockState)((BlockState)((BlockState)((BlockState)this.stateManager.getDefaultState()).with(FACING, Direction.NORTH)).with(HALF, BlockHalf.BOTTOM)).with(SHAPE, StairShape.STRAIGHT)).with(WATERLOGGED, false).with(AXIS, Direction.Axis.Y));
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        return (BlockState)blockState.with(SHAPE, getStairShape(blockState, ctx.getWorld(), blockPos)).with(AXIS, ctx.getSide().getAxis());
    }
    ...
    public static boolean isStairs(BlockState state) {
        return state.getBlock() instanceof AlignedStairsBlock;
    }
    ...
    protected void appendProperties(StateManager.Builder<Block, BlockState> builder) {
        builder.add(new Property[]{FACING, HALF, SHAPE, WATERLOGGED, AXIS});
    }
