...
public class VoidLightBlock extends Block  {
    ...
    public VoidLightBlock(Settings settings) {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (item instanceof EmptyGlassJarItem) {
            ...
            player.getInventory().offerOrDrop(ModItems.VOIDLIGHT_GLASS_JAR.getDefaultStack());
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        return context.isHolding(ModItems.EMPTY_GLASS_JAR) || context.isHolding(ModItems.VOIDLIGHT_GLASS_JAR) ? SOLID : NOT_SOLID;
    }
