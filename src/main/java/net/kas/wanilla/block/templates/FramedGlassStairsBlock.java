...
public final class FramedGlassStairsBlock extends AlignedStairsBlock
{
    public FramedGlassStairsBlock(Settings block$Settings_1)
    {
                                   ...
                                   BlockState blockState_2, Direction direction_1)
    {
        ...
        if(blockState_2.getBlock() == GlassBlocks.FRAMED_GLASS_SLAB)
